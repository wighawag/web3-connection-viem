...
import {createContractEventFilter} from 'viem/_types/actions/public/createContractEventFilter';
...
import {WriteContractReturnType, writeContract} from 'viem/_types/actions/wallet/writeContract';
import {AbiEventParametersToPrimitiveTypes, MaybeExtractEventArgsFromAbi} from 'viem/_types/types/contract';
					...
					: {
							...
							read: {
								[functionName in _ReadFunctionNames]: GetReadFunction<
									_Narrowable,
									TAbi,
									functionName extends ContractFunctionName<TAbi, 'pure' | 'view'> ? functionName : never
								>;
							};
					  }) &
						...
						: {
								...
								simulate: {
									[functionName in _WriteFunctionNames]: GetSimulateFunction<
										_Narrowable,
										_PublicClient['chain'],
										_WalletClient extends Client ? _WalletClient['account'] : _PublicClient['account'],
										TAbi,
										functionName extends ContractFunctionName<TAbi, 'nonpayable' | 'payable'> ? functionName : never
									>;
								};
						...
						: {
								...
								createEventFilter: {
									[EventName in _EventNames]: GetEventFilter<
										_Narrowable,
										TAbi,
										EventName extends ContractEventName<TAbi> ? EventName : never
									>;
								};
								/**
								 * Creates a Filter to retrieve event logs that can be used with [`getFilterChanges`](https://viem.sh/docs/actions/public/getFilterChanges) or [`getFilterLogs`](https://viem.sh/docs/actions/public/getFilterLogs).
					...
					get(_, functionName: string) {
						return (
							...parameters: [
								...
								options?: UnionOmit<ReadContractParameters, 'abi' | 'address' | 'functionName' | 'args'>
							]
						) => {
					...
					get(_, functionName: string) {
						return (
							...parameters: [
								...
								options?: UnionOmit<SimulateContractParameters, 'abi' | 'address' | 'functionName' | 'args'>
							]
						) => {
							const {args, options} = getFunctionParameters(parameters);
							return getAction(
				...
				{},
				{
					get(_, eventName: string) {
						return (
							...parameters: [
								args?: readonly unknown[] | object,
								options?: Omit<GetContractEventsParameters, 'abi' | 'address' | 'eventName'>
							]
						) => {
							const abiEvent = (abi as readonly AbiEvent[]).find(
								(x: AbiEvent) => x.type === 'event' && x.name === eventName
...
type GetReadFunction<
	...
	Options = Prettify<
		UnionOmit<ReadContractParameters<TAbi, TFunctionName, TArgs>, 'abi' | 'address' | 'args' | 'functionName'>
	>
> = Narrowable extends true
	? (
			...parameters: Args extends readonly [] ? [options?: Options] : [args: Args, options?: Options]
	  ) => Promise<ReadContractReturnType<TAbi, TFunctionName, TArgs>>
	: (
			...parameters: [options?: Options] | [args: readonly unknown[], options?: Options]
...
type GetSimulateFunction<
	...
	Args = AbiParametersToPrimitiveTypes<TAbiFunction['inputs']>
> = Narrowable extends true
	? <TChainOverride extends Chain | undefined, TAccountOverride extends Account | Address | undefined = undefined>(
			...parameters: Args extends readonly []
				? [
						options?: Omit<
			...
			SimulateContractReturnType<TAbi, TFunctionName, TArgs, TChain, TAccount, TChainOverride, TAccountOverride>
	  >
	: <TChainOverride extends Chain | undefined, TAccountOverride extends Account | Address | undefined = undefined>(
			...parameters:
				| [
...
> = Narrowable extends true
	...
	: <
			...
			Options extends Prettify<
				...
				>
			>,
			Rest extends unknown[] = IsOptionsRequired extends true ? [options: Options] : [options?: Options]
	  >(
...
type GetEventFilter<
	...
	Options = Prettify<
		Omit<CreateContractEventFilterParameters<TAbi, TEventName>, 'abi' | 'address' | 'args' | 'eventName' | 'strict'>
	>,
	IndexedInputs = Extract<TAbiEvent['inputs'][number], {indexed: true}>
> = Narrowable extends true
	? <
			const TArgs extends MaybeExtractEventArgsFromAbi<TAbi, TEventName> | undefined,
			TStrict extends boolean | undefined = undefined
	  >(
			...parameters: IsNever<IndexedInputs> extends true
				? [options?: Options & {strict?: TStrict}]
				: [args: Args | (Args extends TArgs ? Readonly<TArgs> : never), options?: Options & {strict?: TStrict}]
	  ) => Promise<CreateContractEventFilterReturnType<TAbi, TEventName, TArgs, TStrict>>
	: <TStrict extends boolean | undefined = undefined>(
			...parameters:
				| [options?: Options & {strict?: TStrict}]
				| [args: readonly unknown[] | CreateContractFilterOptions, options?: Options & {strict?: TStrict}]
...
type GetEventsFunction<
	...
	TAbiEvent extends AbiEvent = TAbi extends Abi ? ExtractAbiEvent<TAbi, TEventName> : AbiEvent,
	Args = AbiEventParametersToPrimitiveTypes<TAbiEvent['inputs']>,
	Options = Prettify<Omit<GetContractEventsParameters<TAbi, TEventName>, 'abi' | 'address' | 'args' | 'eventName'>>,
	IndexedInputs = Extract<TAbiEvent['inputs'][number], {indexed: true}>
> = Narrowable extends true
	? (
			...parameters: IsNever<IndexedInputs> extends true ? [options?: Options] : [args?: Args, options?: Options]
	  ) => Promise<GetContractEventsReturnType<TAbi, TEventName>>
	: (
			...parameters: [options?: Options] | [args?: readonly unknown[] | WatchContractEventOptions, options?: Options]
	  ) => Promise<GetContractEventsReturnType<TAbi, TEventName>>;
...
type GetWatchEvent<
	...
	TAbiEvent extends AbiEvent = TAbi extends Abi ? ExtractAbiEvent<TAbi, TEventName> : AbiEvent,
	Args = AbiEventParametersToPrimitiveTypes<TAbiEvent['inputs']>,
	Options = Prettify<Omit<WatchContractEventParameters<TAbi, TEventName>, 'abi' | 'address' | 'args' | 'eventName'>>,
	IndexedInputs = Extract<TAbiEvent['inputs'][number], {indexed: true}>
> = Narrowable extends true
	? (
			...parameters: IsNever<IndexedInputs> extends true ? [options: Options] : [args: Args, options: Options]
